...
public class Message implements Comparable<Message> {
	...
	// ============================================================= //
	// ===== UTILIZADO PARA CONTROLAR A REPLICAÇÃO DA MENSAGEM ===== //
	// ============================================================= //
	// GEA - Gil Eduardo de Andrade
	private int replyMsg;
	private double timeToNextHope; // Tempo até o próximo repasse (alcançar cruzamento)
	private boolean nrCopiesConfig;
	...
	public Message(DTNHost from, DTNHost to, String id, int size) {
		...
		this.appID = null;
		this.replyMsg = 0;
		this.timeToNextHope = 0;
		this.nrCopiesConfig = false;
		this.nrCopies = 0;
	...
	// GEA - Gil Eduardo de Andrade
	// =============================================================================== //
	// ===== MÉTODO PARA SETAR E OBTER CONTROLE SOBRE A REPLICAÇÃO DAS MENSAGENS ===== //
	// =============================================================================== //

	public int getReplyMsg() { return this.replyMsg; }
	public void addReplyMsg() { this.replyMsg ++; }

	public double getTimeNextHope() { return this.timeToNextHope; }
	public void setTimeNextHope(double t) { this.timeToNextHope = t; }

	public boolean getNrCopiesConfig() { return this.nrCopiesConfig; }
	public void setNrCopiesConfig(boolean config) { this.nrCopiesConfig = config; }

	public int getNrCopies() { return this.nrCopies; }
	public void setNrCopies(int nc) { this.nrCopies = nc; }
