...
public abstract class MessageRouter {
	...
	*/
	...
	// Obtém o Parâmetro que indica se o número de cópias está configurado
	public boolean getNrCopiesConfig(Message m) {
		//if(this.messages != null) {
			return this.messages.get(m.getId()).getNrCopiesConfig();
		// }
		//return true;
	}
	// Configura o Parâmetro que indica se o número de cópias está configurado
	public void setNrCopiesConfig(Message m, boolean config) { 		
		//if(this.messages != null) {
			this.messages.get(m.getId()).setNrCopiesConfig(config);
		//}
	}
	// Obtém o número de cópias que ainda podem ser replicadas para uma mensagem
	public int getNrCopies(Message m) {
		//if(this.messages != null) {
			return this.messages.get(m.getId()).getNrCopies();
		//}
		//return 0;
	}
	// Configura o número de cópias que ainda podem ser replicadas para uma mensagem
	public void setNrCopies(Message m, int nr) { 		
		//if(this.messages != null) {
			this.messages.get(m.getId()).setNrCopies(nr);
		//}
	}
}
