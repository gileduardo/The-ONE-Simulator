 ...
 */
public class MessageStatsReport extends Report implements MessageListener, ConnectionListener {
	...
	public void done() {
		...
		String statsText = "created: " + this.nrofCreated + 
			...
			"\nbuffer_occup: " + calcBufferOccupancy() +
			"\nnr_contacts: " + this.nrofContacts +
	...
	// BUFFER OCCUPANCY
	private double calcBufferOccupancy() {
